...
export default function FloatingWhatsApp() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 h-15 w-15 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-[0_12px_36px_-8px_rgba(37,211,102,0.6)]"
    >
