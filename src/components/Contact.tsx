    ...
    <section id="contact" className="py-24 md:py-36 bg-cream/60 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-5 md:px-8">
        <SectionHeading
          ...
          subtitle="Tell us about your date, your vision and your style — we'll take care of everything else."
        />
            ...
            <div className="h-full rounded-[2rem] bg-white shadow-soft p-8 md:p-10 flex flex-col">
              ...
              <ul className="mt-8 space-y-6 flex-1">
                <li className="flex gap-4">
                  ...
                  <div>
                    <p className="text-xs tracking-[0.18em] uppercase text-taupe">Studio</p>
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    <p className="text-xs tracking-[0.18em] uppercase text-taupe">Phone</p>
                ...
                <li className="flex gap-4">
                  <span className="h-11 w-11 shrink-0 rounded-2xl bg-cream border border-champagne/60 flex items-center justify-center">
                    <Mail size={18} className="text-gold-dark" strokeWidth={1.7} />
                  </span>
                  <div>
                    <p className="text-xs tracking-[0.18em] uppercase text-taupe">Email</p>
                    <a href={`mailto:${business.email}`} className="mt-1 block text-cocoa font-light hover:text-gold-dark transition-colors">
                      {business.email}
                    </a>
                  </div>
                </li>
